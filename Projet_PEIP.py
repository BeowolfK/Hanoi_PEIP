...
#Affichage dans le terminal des résultats
            ...
            print(myTable)
#Pour eviter les erreurs, on taskkill excel au cas ou le fichier est encore ouvert
#ATTENTION, NE PAS AVOIR UN AUTRE DOCUMENTS EXCEL SINON IL SERA FERME AUSSI
            try:
